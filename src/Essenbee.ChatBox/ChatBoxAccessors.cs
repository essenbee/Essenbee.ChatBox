...
namespace Essenbee.ChatBox
{
    ...
    public class ChatBoxAccessors
    {
        ...
        public ChatBoxAccessors(ConversationState conversationState) => ConversationState = conversationState ?? throw new ArgumentNullException(nameof(conversationState));
